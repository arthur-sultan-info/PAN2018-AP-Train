...
def train(options):
	...
	classifiers = [MultinomialNB(), RandomForestClassifier(random_state=0, n_estimators=20, n_jobs=2, max_features=None), DecisionTreeClassifier(random_state=0, max_features=None), LinearSVC(random_state=0)]
