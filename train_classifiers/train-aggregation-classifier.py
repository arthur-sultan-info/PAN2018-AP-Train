...
def train(options):
	...
	author_images_object_detection = imageUtils.getSplitFeatures(featuresId='object_detection', splitId=10, splitPath='../splits/splitting-low-meta-combine', languages=options['languages'])
	author_images_face_recognition = imageUtils.getSplitFeatures(featuresId='face_recognition', splitId=10, splitPath='../splits/splitting-low-meta-combine', languages=options['languages'])
	author_images_global_features = imageUtils.getSplitFeatures(featuresId='global_features', splitId=10, splitPath='../splits/splitting-low-meta-combine', languages=options['languages'])
...
if __name__ == "__main__":
	options = {
		...
		'split_path': "../splits/splitting-low-meta-combine",
		'languages': ['ar', 'en', 'es']
	}
